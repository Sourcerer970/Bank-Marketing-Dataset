Here is a machine learning project I did with the Bank Marketing Datset from the UCI Machine Learning Respository using R. I used logistic regression to determine to predict if a
